object frmMain: TfrmMain
  ...
  object pgcMain: TPageControl
    ...
    object tbsExecutar: TTabSheet
      ...
      ImageIndex = 3
      ParentFont = False
      object lblInformePeso: TLabel
        Left = 24
        Top = 32
        Width = 93
        Height = 13
        Caption = 'Informe peso antigo'
      end
      object lblInformeNovoPeso: TLabel
        Left = 210
        Top = 34
        Width = 88
        Height = 13
        Caption = 'Informe novo peso'
      end
      ...
      object btnAddPesos: TButton
        ...
        Caption = 'ADD'
        TabOrder = 2
        OnClick = btnAddPesosClick
      end
      object btnClearPesos: TButton
        Left = 152
        Top = 208
        Width = 50
        Height = 25
